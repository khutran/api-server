...
router.get('/', asyncMiddleware(getAllRole));
router.get('/:id', asyncMiddleware(getRoleById));
router.post('/', asyncMiddleware(createRole));
router.put('/:id', asyncMiddleware(updateRole));
router.delete('/:id', asyncMiddleware(deleteRole));
