...
router.get('/', asyncMiddleware(getAllStatus));
router.get('/:id', asyncMiddleware(getStatusById));
router.post('/', asyncMiddleware(createStatus));
router.put('/:id', asyncMiddleware(updateStatus));
router.delete('/:id', asyncMiddleware(deleteStatus));
